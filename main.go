...
func Editar(w http.ResponseWriter, r *http.Request) {
	idEmpleaado := r.URL.Query().Get("id")
	fmt.Println(idEmpleaado)

	conexionEstablecida := conexionBD()
	registro, err := conexionEstablecida.Query("SELECT * FROM empleados WHERE id=?", idEmpleaado)
...
func Borrar(w http.ResponseWriter, r *http.Request) {
	...
	borrarRegistro.Exec(idEmpleaado)
